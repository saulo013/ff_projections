...
MISSING_TABLE_MESSAGE = """NFLV table name not found in column name dictionary. 
    Please check ff_projections.constants.NFLV_TABLE_DICT.keys()
...
NFLV_TABLE_DICT = {
    ...
    "player_stats": PLAYER_STATS_TBL_COLUMNS,
    "rushing": RUSHING_TBL_COLUMNS,
    "weekly_rosters": WEEKLY_ROSTERS_TBL_COLUMNS,
}
